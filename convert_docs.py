...
## 중요 지침:
- **최소 5000단어 이상**의 상세한 문서를 작성해주세요
- **클래스별 기능과 역할**을 중심으로 상세히 설명해주세요
- 각 클래스의 **실제 사용법과 예제**를 포함해주세요
- **기술적 구현 세부사항**을 구체적으로 설명해주세요
...
3. **시스템 아키텍처** (최소 800단어):
   - 전체 시스템 구조 다이어그램 (Mermaid)
   - 클래스 간 관계와 의존성
   - 데이터 플로우와 상태 관리
   - 설계 패턴과 아키텍처 결정

4. **핵심 기능 구현** (최소 1000단어):
   - 주요 기능의 구현 방법
   - 알고리즘과 로직 설명
   - 성능 최적화 기법
   - 특별한 구현 방식과 해결한 문제

...
#include "STC_IsBossInMeleeRange.generated.h"

/**
 * @brief 보스가 근접 공격 범위에 있는지 확인하는 조건 클래스
 * 
 * StateTree에서 사용되는 조건 클래스로, Evaluator에서 설정된
 * CurrentRangeTag가 Melee 태그와 일치하는지 확인합니다.
 */
UCLASS()
class OPERRATION_DDT_API USTC_IsBossInMeleeRange : public UStateTreeConditionBlueprintBase
{
	GENERATED_BODY()
	 ...
	 * @return true: 근접 공격 범위, false: 다른 범위
	 * 

...
public class Operration_DDT : ModuleRules
{
	public Operration_DDT(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		PublicDependencyModuleNames.AddRange(new string[] { "Core", "CoreUObject", "Engine", "InputCore", "EnhancedInput", "Niagara", "NavigationSystem", "UMG", "MotionWarping","PhysicsCore", "HTTP", "Json", "JsonUtilities","GameplayTags","AIModule", "Blutility" });
